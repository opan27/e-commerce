...
<head>
  ...
  <!-- Favicons -->
  <link href="{{url('template/assets/img/ss-skin-logo.webp')}}" rel="icon">
...
<body>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  <img src="{{url('template/assets/img/ss-skin-logo.webp')}}" alt="">
                  <span class="d-none d-lg-block">Skin Admin </span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="{{url('proses-login')}}">
                    @csrf
                    <div class="col-12">
              ...
              <div class="credits">
                ...
                Designed by <a href="https://bootstrapmade.com/">SS Group</a>
              </div>
  ...
  <script src="{{url('template/assets/vendor/chart.js/chart.umd.js')}}"></script>
  <script src="{{url('template/assets/vendor/echarts/echarts.min.js')}}"></script>
  <script src="{{url('template/assets/vendor/quill/quill.js')}}"></script>
